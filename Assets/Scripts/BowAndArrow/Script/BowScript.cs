...
namespace DigitalRuby.BowAndArrow
{
    ...
    public class BowScript : MonoBehaviour
    {
        ...
        public float MaxRotationAngleRadians = 1.6f;
        ...
        private void BeginBowDraw()
        {
			...
			if (player.transform.localScale.x > 0) {
				Vector3 theScale = currentArrow.transform.localScale;
				theScale.x *= -1;
				currentArrow.transform.localScale = theScale;
			}
...
//			BowShaft.transform.position = player.transform.position + offset ;
